 <?php
	...
	if($bsave == 'Save'){
			$tpass = $_POST['inputpass'];
			
			mysqli_query($conn, "update user_account set Password = '$tpass' where User_id like '$_SESSION[USER_ID]'") or die(mysqli_error($conn));
	...
	<body lang="en" style="background-color: #f8f9fc; ">
		...
		<div class="container-xl mt-5" style="padding: 10px 60px 20px 60px; font-size: 12px; font-family: arial">
			<div class="row">
				...
				<div class="col">
		              ...
		              <div>
		              	<h5>My Profile</h5>
		              	<p style="font-size: 13px">Manage your Password</p>
		              </div>
		              <hr class="style17">
		              <form action="password.php" method="post">
				        ...
				        <div style="float: left; margin-left: 0px" class="container-fluid col-md-8">
				            <div class="form-group row">
		    					...
		    					<div class="col">
		    				    	<input type="Password" id="inputpass" class="form-control" name="inputpass" value="<?php echo $pass;?>" style=" border:none;background-color: white">
		  						</div>
		  					</div>
		  					<div class="form-group row">
		   						<label for="" class="col-sm-3 col-form-label">Confirm Password</label>
		    					<div class="col">
		    				    	<input type="Password" id="inputpass1" class="form-control" name="inputpass" value="<?php echo $pass;?>" style=" border:none;background-color: white">
		  						</div>
		  					</div>
		  					<div class="form-group row">
		...
		<script type="text/javascript">
			...
			var inputPassword = document.getElementById("inputpass")
			  , inputConfirmPassword = document.getElementById("inputpass1");

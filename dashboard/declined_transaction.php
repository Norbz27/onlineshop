<?php
  ...
  $msg = ''; $displayResult = ''; 
    $all_records = mysqli_query($conn, "select * from transaction inner join user_account on transaction.Buyers_Id = user_account.User_ID where ProductStatus_Id = 4") or die(mysqli_error($conn));
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Transactions / Canceled</h1>
          </div>

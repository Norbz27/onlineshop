<?php
  ...
  $all_records = mysqli_query($conn, "select * from transaction where ProductStatus_Id = 2 and Buyers_Id = ".$User_id."") or die(mysqli_error($conn));
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Transactions / Confirmed</h1>
          </div>
            <?php echo $msg; ?>
            <?php echo $displayResult;?>

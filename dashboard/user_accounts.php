<?php
  ...
  $msg = ''; $displayResult = ''; 
    $all_records = mysqli_query($conn, "select * from user_account order by date DESC") or die(mysqli_error($conn));
  if(mysqli_num_rows($all_records) >= 1){
    ...
    while($rowUsers = mysqli_fetch_array($all_records, MYSQLI_ASSOC)){
      ...
      $pnum = $rowUsers['Phone_number'];
      $gender = $rowUsers['Gender'];
      $age = $rowUsers['Age'];
      $bday = $rowUsers['Birthdate'];
      ...
      $displayResult .= '<tr class="text-secondary">
              ...
              <td style="border:none;"><a class="btn btn-danger" href="delete_users.php?uid='.$user_id.'" onclick="return confirm(\'Are you sure you want to delete record?\')"><i class="fas fa-trash-alt"></i></a></td> 
            </tr>';
    }
    $displayResult .= '</tbody>
              </table>
  ...
  if($bsave == 'Update'){
      ...
      mysqli_query($conn, "update user_account set Name='$name', Email='$email', Address='$address', Phone_number='$phone', Gender='$gender', Age='$age', Birthdate='$bday', Username='$username', Password='$password' where User_id = '$_POST[user_id]'") or die(mysqli_error($conn));
                                    ...
                                    <div class="table-responsive">  
                                      <table class="table">
                                        ...
                                        <tr>  
                                             ...
                                             <td style="border:none;" width="50%"><input type="text" id="name" name="name" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Email:</label></td>  
                                             <td style="border:none;" width="50%"><input type="text" id="email" name="email" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Address:</label></td>  
                                             <td style="border:none;" width="50%"><input type="text" id="address" name="address" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Phone Number:</label></td>  
                                             <td style="border:none;" width="50%"><input type="text" id="pnum" name="pnum" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Gender:</label></td>  
                                             <td style="border:none;" width="50%">
                                              <select class="form-control" style=" font-size: 15px; background-color: white;"  id="gender" name="gender">
                                                <option>Male</option>
                                        ...
                                        <tr>  
                                             ...
                                             <td style="border:none;" width="50%"><input type="text" id="age" name="age" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Birthdate:</label></td>  
                                             <td style="border:none;" width="50%"><input type="date" id="bday" name="bday" class="form-control" style=" font-size: 15px; background-color: white;" value=""></td>  
                                        </tr>  
                                        <tr>  
                                             <td style="border:none;padding-top:50px;" width="30%"><label>Username:</label></td>  
                                             <td style="border:none;padding-top:50px;" width="50%"><input type="text" id="username" name="username" class="form-control" style=" font-size: 15px; background-color: white;"></td>  
                                        </tr>
                                        <tr>  
                                             <td style="border:none;" width="30%"><label>Password:</label></td>  
                                             <td style="border:none;" width="50%"><input type="text" id="password" name="password" class="form-control" style="font-size: 15px; background-color: white;" value=""></td>  
                                        </tr>

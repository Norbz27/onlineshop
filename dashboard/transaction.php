<?php
  ...
  $all_records = mysqli_query($conn, "select * from transaction where ProductStatus_Id = 1 and Buyers_Id = ".$User_id."") or die(mysqli_error($conn));
  if(mysqli_num_rows($all_records) >= 1){
    $ctr = 1;
    $displayResult .= '<div class="card shadow mb-4">
            <div class="card-body">
                  ...
                  <?php echo $msg; ?>
                    ...
                    <thead>
                      <tr  class="m-0 font-weight-bold text-dark">
                        ...
                        <th style="border:none;">Add Shipping</th>
                        <th style="border:none;">Confirm</th>
                        <th style="border:none;">Decline</th>
                      </tr>
                     </thead>';
    while($rowUsers = mysqli_fetch_array($all_records, MYSQLI_ASSOC)){
      ...
      $displayResult .= '
              ...
              <td style="border:none;"><a class="btn btn-outline-success con" data-toggle="modal" data-target="#product" href=""><i class="fas fa-plus"></i></a></td>
              <td style="border:none;"><a class="btn btn-outline-success" href="confirm.php?ptid='.$tran_Id.'"><i class="fas fa-check"></i></a></td>
              <td style="border:none;"><a class="btn btn-danger" href="delete_product.php?ptid1='.$tran_Id.'" onclick="return confirm(\'Are you sure you want to delete record?\')"><i class="fas fa-times"></i></a></td>
            </tr>
                        ...
                        <div class="modal-dialog modal-md">  
                             <div class="modal-content">  
                                  ...
                                  <div class="modal-body" id="product_detail">  
                                    <label class="mr-5" style="font-size:20px;">Add Shipping Fee:</label>
                                    <input width="10px" type="text" class="form-control" id="fee" name="fee" placeholder="Shipping Fee">
                                    <input type="hidden" name="pdid" value="'.$rowUsers['Product_Id'].'">
                                    <input type="hidden" name="uid" value="'.$rowUsers['Buyers_Id'].'">
                                    <input type="hidden" name="tid" value="'.$tran_Id.'">
                                  </div>  
  ...
  if($save == 'Add'){
      ...
      mysqli_query($conn, "update transaction set Shipping_Fee = $fee where Product_Id = $pdid and Buyers_Id = $uid and transaction_Id = $tid") or die(mysqli_error($conn));
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Transactions / Pending</h1>
          </div>
            <?php echo $displayResult;?>

          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" role="presentation" style="font-size:13px;" href="C:/wamp64/www/onlineshop/login.php"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>Logout</a>
              </div>
            </li>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?=$sum1;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Product Soled</div>
                      <?php 
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                        $result = mysqli_query($conn, "select SUM(Stock) from product") or die(mysqli_error($conn));
                        $row = mysqli_fetch_array($result);
                      ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$row['SUM(Stock)'];?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                        $result = mysqli_query($conn, "select COUNT(*) from transaction where ProductStatus_Id = 1") or die(mysqli_error($conn));
                        $row = mysqli_fetch_array($result);
                      ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$row['COUNT(*)'];?></div>
                    </div>
